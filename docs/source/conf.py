...
# -*- coding: utf-8 -*-
#
# dlp documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'dlp.tex', 'dlp Documentation',
     'Contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'dlp', 'dlp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dlp', 'dlp Documentation',
     author, 'dlp', 'Data Loss Prevention for credit card numbers',
     'Miscellaneous'),
]
